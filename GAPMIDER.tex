...
\includegraphics{GAPMIDER_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{gapminder }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"India"}\NormalTok{,}\StringTok{"Angola"}\NormalTok{), year}\OperatorTok{>=}\DecValTok{1950}\NormalTok{, year}\OperatorTok{<}\DecValTok{1980}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{GAPMIDER_files/figure-latex/unnamed-chunk-40-1.pdf}
